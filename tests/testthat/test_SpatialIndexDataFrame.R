...
SIndexDF1 = SpatialIndexDataFrame(index = index1, data = dataFrame1)
SIndexDF2 = SpatialIndexDataFrame(index = as.integer(1), data = dataFrame1[1,])
test_that("SpatialIndexDataFrame()", {
# test disabled: expect_error does not work as expected
#  expect_error(# wrong order
#    SpatialIndexDataFrame(index1, dataFrame1)
#  )
...
# test disabled: function was deleted
