...
basicPath1 = paste0(path.package("sensors4plumesData"),"/extdata/fileFormats/raster")
files1 = list.files(basicPath1)

loadedSimulations1 = loadSimulations(
  basicPath = basicPath1,
  nameSave = paste0(path1,"/test1/t1_"),
  overwrite = TRUE
)
...
basicPath2 = paste0(path.package("sensors4plumesData"),"/extdata/fileFormats/raster_multilayer")
loadedSimulations2 = loadSimulations(
  basicPath = basicPath2,
  nameSave = paste0(path1,"/test1/t2_"),
  overwrite = TRUE
)
test_that("loadSimulations raster kind multilayer",{
  # correct values (including correctly used names)
  expect_equivalent(getValues(loadedSimulations1@values[["typec"]]),
                    getValues(loadedSimulations2@values[["sourceA.date1_typec"]])
  )
})

test_that("loadSimulations raster kind multilayer",{
  # correct values (including correctly used names)
  expect_equivalent(getValues(loadedSimulations1@values)[,c("typea", "typeb","typec")],
               getValues(loadedSimulations2@values)[,c("sourceA.date1_typea", "sourceA.date1_typeb", "sourceA.date1_typec")]
  )
})

# files with different number of layers
# basicPath2a = "/home/kristina/Desktop/s4p/data/fileFormats/raster_multilayer_plumes"
basicPath2a = paste0(path.package("sensors4plumesData"),"/extdata/fileFormats/raster_multilayer_plumes")
 expect_error(
   loadedSimulations2a <- loadSimulations(
   basicPath = basicPath2a,
   nameSave = paste0(path1,"/test1/t2a_"),
   overwrite = TRUE)
 )
...
loadedSimulations3 = loadSimulations(# interpret kinds as plumes
  basicPath = basicPath2,
  nameSave = paste0(path1,"/test1/t3_"),
  multilayer = "plumes",
  overwrite = TRUE
)
...
# files with different number of layers
 loadedSimulations3a <- loadSimulations(
     basicPath = basicPath2a,
     nameSave = paste0(path1,"/test1/t3a_"),
     multilayer = "plumes",
     overwrite = TRUE)
...
loadedSimulations4 = loadSimulations(
  basicPath = basicPath1,
  nameSave = paste0(path1,"/test1/t4_"),
  overwrite = TRUE,
  region = region
)
...
loadedSimulations5 = loadSimulations(
  basicPath = basicPath2,
  nameSave = paste0(path1,"/test1/t5_"),
  overwrite = TRUE,
  region = region
)
test_that("loadSimulations raster kind multilayer, region",{
  expect_equal(nLocations(loadedSimulations5), sum(region))
  expect_equivalent(getValues(loadedSimulations4@values),
                    getValues(loadedSimulations5@values)[,c(3,2,1)]
  )
})
...
loadedSimulations6 = loadSimulations(# interpret kinds as plumes
  basicPath = basicPath2,
  nameSave = paste0(path1,"/test1/t6_"),
  multilayer = "plumes",
  overwrite = TRUE,
  region = region
)
...
loadedSimulations7 = loadSimulations(
  basicPath = basicPath1,
  nameSave = paste0(path1,"/test1/t7_"),
  overwrite = TRUE,
  bBox = bBox
)
...
loadedSimulations8 = loadSimulations(
  basicPath = basicPath1,
  nameSave = paste0(path1,"/test1/t8_"),
  overwrite = TRUE,
  region = regionBBox,
  bBox = bBox
)
...
expect_warning(
  ...
  basicPath = basicPath1,
  nameSave = paste0(path1,"/test1/t9_"),
  overwrite = TRUE,
...
# B) text files    a)
basicPath3 =  paste0(path.package("sensors4plumesData"),"/extdata/fileFormats/text")
files3 = list.files(basicPath3)

LoadedSimulations10 = loadSimulations(
  basicPath = basicPath3,
  nameSave = paste0(path1,"/test1/t10_"),
  overwrite = TRUE
)
...
# B)               b)
basicPath4 =  paste0(path.package("sensors4plumesData"),"/extdata/fileFormats/text_multicolumn")
files4 = list.files(basicPath4)

LoadedSimulations11 = loadSimulations(
  basicPath = basicPath4,
  nameSave = paste0(path1,"/test1/t11_"),
  overwrite = TRUE,
  readBy = "scan",
  skip = 1
)
...
test_that("loadSimulations txt kind multilayer",{
  expect_equivalent(getValues(loadedSimulations11@values),
               getValues(loadedSimulations10@values)
  )
})
...
basicPath4a = paste0(path.package("sensors4plumesData"),"/extdata/fileFormats/text_multicolumn_plumes")

expect_error(
  LoadedSimulations11a <- loadSimulations(
  basicPath = basicPath4a,
  nameSave = paste0(path1,"/test1/t11a_"),
  overwrite = TRUE,
  readBy = "scan",
  skip = 1,
  sep = ",")
...
expect_error(
  LoadedSimulations11b <- loadSimulations(
    basicPath = basicPath4a,
    nameSave = paste0(path1,"/test1/t11b_"),
    overwrite = TRUE,
    readBy = "scan",
    skip = 1,
    sep = ",",
...
LoadedSimulations14 = loadSimulations(# interpret kinds as plumes
  basicPath = basicPath4,
  nameSave = paste0(path1,"/test1/t14_"),
  multilayer = "plumes",
  overwrite = TRUE,
  readBy = "scan",
  skip = 1
...
LoadedSimulations14a <- loadSimulations(
  basicPath = basicPath4a,
  nameSave = paste0(path1,"/test1/t14a_"),
  multilayer = "plumes",
  overwrite = TRUE,
  readBy = "scan",
  skip = 1, sep = ",")
...
LoadedSimulations15 = loadSimulations(
  basicPath = basicPath3,
  nameSave = paste0(path1,"/test1/t15_"),
  overwrite = TRUE,
  region = region
)
...
LoadedSimulations16 = loadSimulations(
  basicPath = basicPath4,
  nameSave = paste0(path1,"/test1/t16_"),
  overwrite = TRUE,
  readBy = "scan",
  skip = 1,
  region = region
...
test_that("loadSimulations txt kind multilayer, region",{
  ...
  expect_equivalent(getValues(LoadedSimulations16[["values"]]),
               getValues(LoadedSimulations15[["values"]])
  )
})
# number of columns differs among files
expect_error(
  LoadedSimulations16a <- loadSimulations(
    basicPath = basicPath4a,
    nameSave = paste0(path1,"/test1/t16a_"),
    region = region,
    overwrite = TRUE,
    readBy = "scan",
    skip = 1, sep = ",")
...
LoadedSimulations17 = loadSimulations(# interpret kinds as plumes
  basicPath = basicPath4,
  nameSave = paste0(path1,"/test1/t17_"),
  multilayer = "plumes",
  overwrite = TRUE,
  readBy = "scan",
  skip = 1,
...
LoadedSimulations17a <- loadSimulations(
    basicPath = basicPath4a,
    nameSave = paste0(path1,"/test1/t17a_"),
    region = region,
    overwrite = TRUE,
    multilayer = "plumes",
    readBy = "scan",
