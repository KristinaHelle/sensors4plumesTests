...
test_that("replaceDefault",{
  ...
  fun4__ = function(simulations = 10, locations){1}
  expect_equal(
    fun_4[[1]], fun4__ # fitting parameters replaced
  )
  expect_false(
    fun_4[[2]]
  )
  ...
  fun5__ = function(x = 10, nout){x}
  expect_equal(
    fun_5[[1]], fun5__ # default replaced
  )
  expect_false(
    fun_5[[2]]
  )
  ...
  fun6__ = function(x = 17, weight = 3, extraWeight = "c"){}
  expect_equal(
    fun_6[[1]], fun6__
  )
  expect_true(
